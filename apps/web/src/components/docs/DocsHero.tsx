  ...
  return (
    <section className="py-20 px-6 max-w-5xl mx-auto">
      ...
      <button
        ...
        className="mt-8 flex items-center bg-surface border border-border rounded-xl px-4 py-3 max-w-xl w-full text-left hover:border-blue-500/30 transition-colors"
      >
